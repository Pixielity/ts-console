...
var GreetCommand = class extends BaseCommand {
  ...
  async execute() {
    try {
      ...
      switch (color) {
        case "red":
          coloredGreeting = chalk2.red(greeting);
          break;
        case "green":
          coloredGreeting = chalk2.green(greeting);
          break;
        case "blue":
          coloredGreeting = chalk2.blue(greeting);
          break;
        case "yellow":
          coloredGreeting = chalk2.yellow(greeting);
          break;
        case "cyan":
          coloredGreeting = chalk2.cyan(greeting);
          break;
        default:
          coloredGreeting = chalk2.green(greeting);
      }
