...
var ListCommand = class extends BaseCommand {
  ...
  async execute() {
    try {
      ...
      this.line(chalk3.dim("Use command name, alias, or shortcut to run a command"));
      this.line("");
      ...
      for (const [category, groupCommands] of Object.entries(commandGroups)) {
        ...
        groupCommands.forEach((command) => {
          ...
          table.addRow([
            chalk3.green(command.getName()),
            aliases ? chalk3.yellow(aliases) : "",
            shortcuts ? chalk3.magenta(shortcuts) : "",
