...
exports.ListCommand = class ListCommand extends BaseCommand {
  ...
  async execute() {
    try {
      ...
      this.line(chalk__default.default.bold("Available commands:"));
      this.line("");
      ...
      for (const [category, groupCommands] of Object.entries(commandGroups)) {
        this.line(chalk__default.default.cyan(`${category.charAt(0).toUpperCase() + category.slice(1)} Commands:`));
        ...
        groupCommands.forEach((command) => {
          ...
          table.addRow([chalk__default.default.green(command.getName()), aliases ? chalk__default.default.yellow(aliases) : "", command.getDescription()]);
        });
        table.render();
        this.line("");
      }
